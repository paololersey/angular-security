...
app.route('/api/lessons')
    .get(checkIfAuthenticated, partial(checkIfAuthorized, ['STUDENT']), readAllLessons);
// REST API
app.route('/api/admin')
    .post(checkIfAuthenticated, partial(checkIfAuthorized, ['ADMIN']), loginAsUser, readAllLessons);
